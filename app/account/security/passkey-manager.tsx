...
export default function PasskeyManager() {
  ...
  return <div className="mt-6 rounded-2xl border border-slate-200 bg-white p-6">
    <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
      ...
      <button type="button" onClick={register} disabled={registering || loading} className="rounded-xl bg-slate-900 px-4 py-2.5 text-sm font-medium text-white hover:bg-slate-800 disabled:opacity-50">{registering ? 'Registering…' : 'Add a passkey'}</button>
    </div>
